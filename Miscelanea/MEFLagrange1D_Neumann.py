...
Resolvemos un problema de contorno de segundo orden, con condiciones de tipo Neumann,
mediante el MEF unidimensional, usando el E.F. de Lagrange lineal
...
p1 # las dos condiciones de contorno de tipo Neumann impuestas
...
def yexacta(z):
    ...
    return ya + z*(dyb - sp.cos(b)) + sp.sin(z)
...
for i in range(1,nx): # y ahora la diagonal inferior adyacente
...
B = np.zeros(nx); # vamos ahora con el vector de términos independientes
